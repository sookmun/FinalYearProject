...
[baseFileName, folder] = uigetfile({'*.jpg';'*.png'}); 
fullFileName = fullfile(folder, baseFileName);
theImage = imread(fullFileName);
img_seg = segmenta(theImage);
[lesh] = calc_LESH(img_seg);
final = num2cell(lesh);
final= cell2table(final);
final.Properties.VariableNames = {'final_1','final_2','final_3','final_4','final_5','final_6','final_7','final_8',...
